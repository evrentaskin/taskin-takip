...
import { recordStudentActivity } from './services/studentActivity'
...
export default function App() {
  ...
  useEffect(() => {
    if (!session?.user?.id || !['student', 'private_student'].includes(profile?.role)) return undefined

    const markActive = () => recordStudentActivity('app_active')
