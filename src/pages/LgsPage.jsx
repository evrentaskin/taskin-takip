    ...
    lessonDefs.forEach(lesson=>{
      for(let q=1;q<=lesson.count;q++){
        ...
        participants.forEach(p=>{
          const answer=p.answers?.[key] ?? p.answers?.[lesson.key]?.[q] ?? p.answers?.[lesson.key]?.[String(q)]
