...
export default function StudentHomePage({ session, profile }) {
  ...
  function StudentDrawer() {
    return <Box className="student-drawer">
      <Box className="student-drawer-brand"><img src="/taskin-logo-symbol.png" alt="TAŞKIN"/><Box><Typography fontWeight={950}>TAŞKIN</Typography><Typography variant="caption">Öğrenci Paneli</Typography></Box></Box>
      <Divider />
